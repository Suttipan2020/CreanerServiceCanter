			...
			public ModelAndView getEditProfileDataCustomer(HttpServletRequest request,HttpSession session, Model md) {
				...
				try {
					...
					if(typeAccount != null) {
						...
						Login login = new Login(uname, pwd, "เธฅเธนเธ�เธ�เน�เธฒ", "เธญเธ�เธธเธ�เธฒเธ•เน�เธซเน�เน€เธ�เน�เธฒเน�เธ�เน�เธ�เธฒเธ�");
						...
						if (ServletFileUpload.isMultipartContent(request)) {
							List<FileItem> data = new ServletFileUpload(new DiskFileItemFactory()).parseRequest(request);
							  ...
							  System.out.println("typeAccountProvider ==" + typeAccountProvider);
									...
									if(typeAccountProvider.equals("2")) {
										...
										for (CleanerProvider cp : cleanerProviders) {
										  ...
										  DateFormat df = new SimpleDateFormat("dd/MM/yyyy");
											...
											Date dbay = df.parse(birthday);
										Login login = new Login(user.getUsername(), pwd, "เน�เธซเน�เธ�เธฃเธดเธ�เธฒเธฃเธ—เธณเธ�เธงเธฒเธกเธชเธฐเธญเธฒเธ”", "เธญเธ�เธธเธ�เธฒเธ•เน�เธซเน�เน€เธ�เน�เธฒเน�เธ�เน�เธ�เธฒเธ�");
	
										ServicePerson sperson = new ServicePerson(mID, tel, email, address, subdistrict, district, province,
												postcode, latitude, longitude, login, cpid, "เธ�เธธเธ�เธ�เธฅ", profilePhoto, spID, fname, lname,
										...
										Company company = new Company(mID, tel, email, address, subdistrict, district, province, postcode,
												latitude,longitude, login, cpid,"เธ�เธฃเธดเธฉเธฑเธ—",profilePhoto,	comID,companyName,contactName, 
									...
									if(message.equals("1")) {
										...
										List<Member> membersload  = em.findMemberData(user);
											...
											List<CleanerProvider> cp = em.findMemberDataForCleanerProvider(mid);
												...
												request.setAttribute("providertype", providertype);
												if(providertype.equals("เธ�เธธเธ�เธ�เธฅ")) {
								...
								System.out.println("เน�เธกเน�เธชเธฒเธกเธฒเธฃเธ–เน�เธ�เน�เน�เธ�เธ�เน�เธญเธกเธนเธฅเน�เธ”เน�");
							}
						}
					}
				} catch (Exception e) {
